        ...
        <div className="pt-8 border-t border-gray-100 dark:border-gray-800/50">
            <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                    <span>
                        <svg className="inline-block w-4 h-4 mr-1 text-blue-700 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                ...
                <nav className="flex items-center gap-4 sm:gap-6" role="navigation" aria-label="Footer navigation">
                    <Link
                        to="/privacy-policy"
                        className="group relative flex items-center gap-1 text-sm text-gray-700 dark:text-gray-300 hover:text-blue-800 dark:hover:text-blue-200 transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-blue-500 rounded-sm"
                        aria-label="Privacy Policy"
                        tabIndex={0}
                    >
                        <svg className="w-4 h-4 mr-1 text-blue-600 group-hover:text-blue-800 dark:group-hover:text-blue-200 transition" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M12 3v1m0 0a9 9 0 019 9v7a2 2 0 01-2 2H5a2 2 0 01-2-2v-7a9 9 0 019-9z" />
                        </svg>
                        Privacy
                        <span className="absolute left-1/2 -translate-x-1/2 top-full mt-1 px-2 py-1 rounded bg-gray-900 text-white text-xs opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity duration-200 shadow-lg whitespace-nowrap z-20">
