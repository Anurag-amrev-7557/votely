...
const AdminLogin = () => {
  ...
  const { login, validateSession, logout } = useAdminAuth();
  ...
  }, [securityState.isBiometricAvailable, login, navigate, from, performSecurityChecks]);
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 dark:from-[#0f1419] dark:via-[#1a1f2e] dark:to-[#15191e] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full mx-auto space-y-8">
        ...
        {/* Enhanced Form */}
        <form ref={formRef} className="mt-8 space-y-6" onSubmit={handleSubmit} onKeyDown={handleKeyDown}>
