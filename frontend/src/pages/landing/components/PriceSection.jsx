...
const PricingFeature = ({
    ...
    return (
        <div
            className={`relative group text-[13px] font-normal leading-normal flex gap-3 items-center transition-all duration-300 ${
                highlight
        ...
        >
            ...
            {tooltip && (
                <span className="relative flex items-center ml-1">
                    ...
                    <span
                        className={`absolute left-1/2 top-full z-20 mt-2 w-max min-w-[180px] max-w-xs px-3 py-2 rounded-lg bg-gray-900/90 text-xs text-white shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 group-focus:opacity-100 transition-opacity duration-200
